...
_t_pc_channel:     file format elf32-i386
       ...
       f:	31 db                	xor    %ebx,%ebx
{
    ...
    ch = channel_create(5);
      ...
      1d:	6a 05                	push   $0x5
      1f:	e8 4c 0e 00 00       	call   e70 <channel_create>
      24:	83 c4 10             	add    $0x10,%esp
      27:	a3 c0 1a 00 00       	mov    %eax,0x1ac0
        p[i] = thread_create(producer, (void *)i);
      2c:	83 ec 08             	sub    $0x8,%esp
      2f:	53                   	push   %ebx
      30:	68 d0 00 00 00       	push   $0xd0
      35:	e8 66 08 00 00       	call   8a0 <thread_create>
    for (int i = 0; i < PRODUCERS; i++)
      3a:	83 c4 10             	add    $0x10,%esp
        p[i] = thread_create(producer, (void *)i);
      3d:	89 44 9d dc          	mov    %eax,-0x24(%ebp,%ebx,4)
    for (int i = 0; i < PRODUCERS; i++)
      41:	83 c3 01             	add    $0x1,%ebx
      44:	83 fb 03             	cmp    $0x3,%ebx
      47:	75 e3                	jne    2c <main+0x2c>

    for (int i = 0; i < CONSUMERS; i++)
        c[i] = thread_create(consumer, (void *)i);
      49:	83 ec 08             	sub    $0x8,%esp
      4c:	6a 00                	push   $0x0
      4e:	68 20 01 00 00       	push   $0x120
      53:	e8 48 08 00 00       	call   8a0 <thread_create>
      58:	89 c6                	mov    %eax,%esi
      5a:	58                   	pop    %eax
      5b:	5a                   	pop    %edx
      5c:	6a 01                	push   $0x1
      5e:	68 20 01 00 00       	push   $0x120
      63:	e8 38 08 00 00       	call   8a0 <thread_create>

    for (int i = 0; i < PRODUCERS; i++)
        thread_join(p[i]);
      68:	59                   	pop    %ecx
      69:	ff 75 dc             	push   -0x24(%ebp)
        c[i] = thread_create(consumer, (void *)i);
      6c:	89 c3                	mov    %eax,%ebx
        thread_join(p[i]);
      6e:	e8 1d 0a 00 00       	call   a90 <thread_join>
      73:	58                   	pop    %eax
      74:	ff 75 e0             	push   -0x20(%ebp)
      77:	e8 14 0a 00 00       	call   a90 <thread_join>
      7c:	58                   	pop    %eax
      7d:	ff 75 e4             	push   -0x1c(%ebp)
      80:	e8 0b 0a 00 00       	call   a90 <thread_join>

    printf(1, "All producers finished. Closing channel.\n");
      85:	58                   	pop    %eax
      86:	5a                   	pop    %edx
      87:	68 f4 12 00 00       	push   $0x12f4
      8c:	6a 01                	push   $0x1
      8e:	e8 6d 04 00 00       	call   500 <printf>
    channel_close(ch);
      93:	59                   	pop    %ecx
      94:	ff 35 c0 1a 00 00    	push   0x1ac0
      9a:	e8 d1 0f 00 00       	call   1070 <channel_close>

    for (int i = 0; i < CONSUMERS; i++)
        thread_join(c[i]);
      9f:	89 34 24             	mov    %esi,(%esp)
      a2:	e8 e9 09 00 00       	call   a90 <thread_join>
      a7:	89 1c 24             	mov    %ebx,(%esp)
      aa:	e8 e1 09 00 00       	call   a90 <thread_join>

    printf(1, "All consumers exited.\n");
      af:	5b                   	pop    %ebx
      b0:	5e                   	pop    %esi
      b1:	68 d4 12 00 00       	push   $0x12d4
      b6:	6a 01                	push   $0x1
      b8:	e8 43 04 00 00       	call   500 <printf>
    exit();
      bd:	e8 f1 02 00 00       	call   3b3 <exit>
      c2:	66 90                	xchg   %ax,%ax
      c4:	66 90                	xchg   %ax,%ax
      c6:	66 90                	xchg   %ax,%ax
      c8:	66 90                	xchg   %ax,%ax
...
000000d0 <producer>:
{
    ...
    for (int i = 0; i < ITEMS_PER_PROD; i++) {
      ...
      e3:	53                   	push   %ebx
      e4:	ff 35 c0 1a 00 00    	push   0x1ac0
      ea:	e8 21 0e 00 00       	call   f10 <channel_send>
    ...
    for (int i = 0; i < ITEMS_PER_PROD; i++) {
      f0:	83 c3 01             	add    $0x1,%ebx
        printf(1, "Producer %d: sent %d\n", id, i);
      f3:	56                   	push   %esi
      f4:	68 a4 12 00 00       	push   $0x12a4
      f9:	6a 01                	push   $0x1
      fb:	e8 00 04 00 00       	call   500 <printf>
        thread_yield();
     100:	83 c4 20             	add    $0x20,%esp
     103:	e8 08 09 00 00       	call   a10 <thread_yield>
    for (int i = 0; i < ITEMS_PER_PROD; i++) {
     108:	83 fb 0a             	cmp    $0xa,%ebx
     10b:	75 d3                	jne    e0 <producer+0x10>
}
...
00000120 <consumer>:
{
     ...
     123:	56                   	push   %esi
     124:	53                   	push   %ebx
     125:	8d 5d f4             	lea    -0xc(%ebp),%ebx
     128:	83 ec 10             	sub    $0x10,%esp
     12b:	8b 75 08             	mov    0x8(%ebp),%esi
    while (channel_recv(ch, &data) == 0) {
     12e:	eb 18                	jmp    148 <consumer+0x28>
        printf(1, "Consumer %d: received %d\n", id, (int)data);
     130:	ff 75 f4             	push   -0xc(%ebp)
     133:	56                   	push   %esi
     134:	68 ba 12 00 00       	push   $0x12ba
     139:	6a 01                	push   $0x1
     13b:	e8 c0 03 00 00       	call   500 <printf>
        thread_yield();
     140:	e8 cb 08 00 00       	call   a10 <thread_yield>
     145:	83 c4 10             	add    $0x10,%esp
    while (channel_recv(ch, &data) == 0) {
     148:	83 ec 08             	sub    $0x8,%esp
     14b:	53                   	push   %ebx
     14c:	ff 35 c0 1a 00 00    	push   0x1ac0
     152:	e8 69 0e 00 00       	call   fc0 <channel_recv>
     157:	83 c4 10             	add    $0x10,%esp
     15a:	85 c0                	test   %eax,%eax
     15c:	74 d2                	je     130 <consumer+0x10>
}
     ...
     468:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     49b:	0f b6 92 78 13 00 00 	movzbl 0x1378(%edx),%edx
     ...
     509:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     574:	ff 24 85 20 13 00 00 	jmp    *0x1320(,%eax,4)
  ...
  write(fd, &c, 1);
     ...
     680:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
     685:	bb eb 12 00 00       	mov    $0x12eb,%ebx
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     691:	a1 c4 1a 00 00       	mov    0x1ac4,%eax
{
  ...
  freep = p;
     ...
     6cf:	5b                   	pop    %ebx
  freep = p;
     6d0:	a3 c4 1a 00 00       	mov    %eax,0x1ac4
}
     6d5:	5e                   	pop    %esi
     6d6:	5f                   	pop    %edi
     6d7:	5d                   	pop    %ebp
     ...
     6e6:	72 ce                	jb     6b6 <free+0x26>
{
  ...
  freep = p;
     70a:	a3 c4 1a 00 00       	mov    %eax,0x1ac4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     72c:	8b 15 c4 1a 00 00    	mov    0x1ac4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
     ...
     76b:	3b 05 c4 1a 00 00    	cmp    0x1ac4,%eax
  ...
  return freep;
     793:	8b 15 c4 1a 00 00    	mov    0x1ac4,%edx
     ...
     7bc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
     7bf:	89 15 c4 1a 00 00    	mov    %edx,0x1ac4
}
     ...
     7cf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
     7d0:	c7 05 c4 1a 00 00 c8 	movl   $0x1ac8,0x1ac4
     7d7:	1a 00 00 
    base.s.size = 0;
     7da:	b8 c8 1a 00 00       	mov    $0x1ac8,%eax
    base.s.ptr = freep = prevp = &base;
     7df:	c7 05 c8 1a 00 00 c8 	movl   $0x1ac8,0x1ac8
     7e6:	1a 00 00 
    base.s.size = 0;
     7e9:	c7 05 cc 1a 00 00 00 	movl   $0x0,0x1acc
     7f0:	00 00 00 
    if(p->s.size >= nunits){
...
thread_init(void)
{
    for (int i = 0; i < MAX_THREADS; i++) {
     810:	b8 00 1b 00 00       	mov    $0x1b00,%eax
    ...
    for (int i = 0; i < MAX_THREADS; i++) {
     852:	3d 00 1d 00 00       	cmp    $0x1d00,%eax
     857:	75 bf                	jne    818 <thread_init+0x8>
    }

    threads[0].tid = 0;
     859:	c7 05 00 1b 00 00 00 	movl   $0x0,0x1b00
     860:	00 00 00 
    threads[0].state = T_RUNNING;
     863:	c7 05 04 1b 00 00 02 	movl   $0x2,0x1b04
     86a:	00 00 00 
    threads[0].waiting_tid = -1;
     86d:	c7 05 1c 1b 00 00 ff 	movl   $0xffffffff,0x1b1c
     874:	ff ff ff 

    current_thread = &threads[0];
     877:	c7 05 e0 1a 00 00 00 	movl   $0x1b00,0x1ae0
     87e:	1b 00 00 
}
     881:	c3                   	ret
...
thread_self(void)
{
    return current_thread->tid;
     890:	a1 e0 1a 00 00       	mov    0x1ae0,%eax
     ...
     8a1:	31 c0                	xor    %eax,%eax
{
     ...
     8b5:	8b 93 04 1b 00 00    	mov    0x1b04(%ebx),%edx
    ...
    t->tid = next_tid++;
     8d8:	a1 bc 1a 00 00       	mov    0x1abc,%eax
     8dd:	8d b3 00 1b 00 00    	lea    0x1b00(%ebx),%esi
    ...
    t->tid = next_tid++;
     8ed:	89 83 00 1b 00 00    	mov    %eax,0x1b00(%ebx)
     8f3:	8d 50 01             	lea    0x1(%eax),%edx
    t->start_routine = start_routine;
     8f6:	8b 45 08             	mov    0x8(%ebp),%eax
    t->tid = next_tid++;
     8f9:	89 15 bc 1a 00 00    	mov    %edx,0x1abc
    t->start_routine = start_routine;
    ...
    *(--sp) = 0;
    ...
    return t->tid;
     957:	8b 83 00 1b 00 00    	mov    0x1b00(%ebx),%eax
}
...
thread_schedule(void)
{
    ...
    for (int i = 0; i < MAX_THREADS; i++) {
     ...
     9b5:	83 b9 04 1b 00 00 01 	cmpl   $0x1,0x1b04(%ecx)
     9bc:	8d b9 00 1b 00 00    	lea    0x1b00(%ecx),%edi
    ...
    current_thread = next;
     9eb:	89 3d e0 1a 00 00    	mov    %edi,0x1ae0
    next->state = T_RUNNING;
     9f1:	c7 82 04 1b 00 00 02 	movl   $0x2,0x1b04(%edx)
     9f8:	00 00 00 
    thread_switch(old, next);
     9fb:	57                   	push   %edi
     9fc:	56                   	push   %esi
...
thread_exit(void *retval)
{
    ...
    current_thread->retval = retval;
     a26:	a1 e0 1a 00 00       	mov    0x1ae0,%eax
    ...
    if (current_thread->waiting_tid >= 0) {
     ...
     a4d:	3b 8a 00 1b 00 00    	cmp    0x1b00(%edx),%ecx
    ...
    for (;;)
     ...
     a64:	c7 82 04 1b 00 00 01 	movl   $0x1,0x1b04(%edx)
     a6b:	00 00 00 
                break;
...
00000a70 <thread_trampoline>:
{
    ...
    void *ret = current_thread->start_routine(current_thread->arg);
     a76:	a1 e0 1a 00 00       	mov    0x1ae0,%eax
     ...
     a96:	31 db                	xor    %ebx,%ebx
{
     ...
     aa5:	39 90 00 1b 00 00    	cmp    %edx,0x1b00(%eax)
    ...
    while (target->state != T_ZOMBIE) {
     ac8:	83 b8 04 1b 00 00 04 	cmpl   $0x4,0x1b04(%eax)
     acf:	8d b0 00 1b 00 00    	lea    0x1b00(%eax),%esi
     ad5:	74 25                	je     afc <thread_join+0x6c>
     ad7:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
     ade:	00 
     adf:	90                   	nop
        current_thread->state = T_SLEEPING;
     ae0:	a1 e0 1a 00 00       	mov    0x1ae0,%eax
    ...
    void *ret = target->retval;
     b02:	8b bb 18 1b 00 00    	mov    0x1b18(%ebx),%edi
    free(target->stack);
     b08:	ff b3 08 1b 00 00    	push   0x1b08(%ebx)
    ...
    target->stack = 0;
     b18:	c7 83 08 1b 00 00 00 	movl   $0x0,0x1b08(%ebx)
     b1f:	00 00 00 
    target->state = T_UNUSED;
     b22:	c7 83 04 1b 00 00 00 	movl   $0x0,0x1b04(%ebx)
     b29:	00 00 00 
    target->tid = -1;
     b2c:	c7 83 00 1b 00 00 ff 	movl   $0xffffffff,0x1b00(%ebx)
     b33:	ff ff ff 
}
...
sem_wait(sem_t *s)
{
    ...
    if (s->count < 0) {
     ...
     b7b:	a1 e0 1a 00 00       	mov    0x1ae0,%eax
...
sem_post(sem_t *s)
{
    ...
    if (s->count <= 0 && s->wait_count > 0) {
     ...
     bfd:	39 9a 00 1b 00 00    	cmp    %ebx,0x1b00(%edx)
     c03:	75 eb                	jne    bf0 <sem_post+0x50>
                threads[i].state = T_RUNNABLE;
     c05:	c7 82 04 1b 00 00 01 	movl   $0x1,0x1b04(%edx)
     c0c:	00 00 00 
}
     c0f:	5b                   	pop    %ebx
     c10:	5e                   	pop    %esi
...
cond_wait(cond_t *c, mutex_t *m)
{
    ...
    c->wait_queue[c->wait_count++] = current_thread->tid;
     ...
     c46:	8b 0d e0 1a 00 00    	mov    0x1ae0,%ecx
    ...
    current_thread->state = T_SLEEPING;
     c57:	a1 e0 1a 00 00       	mov    0x1ae0,%eax
...
cond_signal(cond_t *c)
{
    ...
    for (int i = 0; i < MAX_THREADS; i++) {
     ...
     cbd:	39 8a 00 1b 00 00    	cmp    %ecx,0x1b00(%edx)
    ...
    for (int i = 0; i < MAX_THREADS; i++) {
     ...
     cd2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            threads[i].state = T_RUNNABLE;
     cd8:	c7 82 04 1b 00 00 01 	movl   $0x1,0x1b04(%edx)
     cdf:	00 00 00 
}
     ce2:	5b                   	pop    %ebx
     ce3:	5e                   	pop    %esi
...
mutex_lock(mutex_t *m)
{
    ...
    while (m->locked) {
     ...
     d97:	74 17                	je     db0 <mutex_lock+0x50>
        if (m->owner == current_thread->tid)
     d99:	a1 e0 1a 00 00       	mov    0x1ae0,%eax
    ...
    m->owner = current_thread->tid;
     db6:	a1 e0 1a 00 00       	mov    0x1ae0,%eax
...
mutex_unlock(mutex_t *m)
{
     dd0:	55                   	push   %ebp
    if (m->owner != current_thread->tid)
     dd1:	a1 e0 1a 00 00       	mov    0x1ae0,%eax
{
    ...
    for (int i = 0; i < MAX_THREADS; i++) {
     ...
     e1d:	39 9a 00 1b 00 00    	cmp    %ebx,0x1b00(%edx)
    ...
    for (int i = 0; i < MAX_THREADS; i++) {
     ...
     e4a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            threads[i].state = T_RUNNABLE;
     e50:	c7 82 04 1b 00 00 01 	movl   $0x1,0x1b04(%edx)
     e57:	00 00 00 
            m->owner = next_tid;
